...
_0x3:
; 0000 0085       {
; 0000 0086        PORTB = 0b11111111; //isi kolom 1
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0087     PORTA = 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 0088 //mengaktifkan baris 1 , active low
; 0000 0089     delay_ms(1);
; 0000 008A 
; 0000 008B     PORTB = 0b11111111; //isi kolom 2
; 0000 008C     PORTA = 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 008D     delay_ms(1);
; 0000 008E 
; 0000 008F     PORTB = 0b11111111; //isi kolom 3
; 0000 0090     PORTA = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x1
; 0000 0091     delay_ms(1);
; 0000 0092 
; 0000 0093     PORTB = 0b00000000; //isi kolom 4
; 0000 0094     PORTA = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x1
; 0000 0095     delay_ms(1);
; 0000 0096 
; 0000 0097     PORTB = 0b00000000; //isi kolom 5
; 0000 0098     PORTA = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 0099     delay_ms(1);
; 0000 009A 
; 0000 009B     PORTB = 0b11111111; //isi kolom 6
; 0000 009C     PORTA = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 009D     delay_ms(1);
; 0000 009E 
; 0000 009F     PORTB = 0b11111111; //isi kolom 7
; 0000 00A0     PORTA = 0b0100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 00A1     delay_ms(1);
; 0000 00A2 
; 0000 00A3     PORTB = 0b11111111; //isi kolom 8
; 0000 00A4     PORTA = 0b10000000;
	LDI  R30,LOW(128)
	OUT  0x1B,R30
...
; 0000 00A6 
; 0000 00A7 
; 0000 00A8     PORTD = 0b11111111; //isi kolom 1
; 0000 00A9     PORTC = 0b00000001;
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 00AA     delay_ms(1);
	RCALL SUBOPT_0x2
; 0000 00AB 
; 0000 00AC     PORTD = 0b11111111; //isi kolom 2
; 0000 00AD     PORTC = 0b00000010;
	LDI  R30,LOW(2)
	OUT  0x15,R30
; 0000 00AE     delay_ms(1);
	RCALL SUBOPT_0x2
; 0000 00AF 
; 0000 00B0     PORTD = 0b11111111; //isi kolom 3
; 0000 00B1     PORTC = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x3
; 0000 00B2     delay_ms(1);
; 0000 00B3 
; 0000 00B4     PORTD = 0b00000000; //isi kolom 4
; 0000 00B5     PORTC = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x3
; 0000 00B6     delay_ms(1);
; 0000 00B7 
; 0000 00B8     PORTD = 0b00000000; //isi kolom 5
; 0000 00B9     PORTC = 0b00010000;
	LDI  R30,LOW(16)
	OUT  0x15,R30
; 0000 00BA     delay_ms(1);
	RCALL SUBOPT_0x2
; 0000 00BB 
; 0000 00BC     PORTD = 0b11111111; //isi kolom 6
; 0000 00BD     PORTC = 0b00100000;
	LDI  R30,LOW(32)
	OUT  0x15,R30
; 0000 00BE     delay_ms(1);
	RCALL SUBOPT_0x2
; 0000 00BF 
; 0000 00C0     PORTD = 0b11111111; //isi kolom 7
; 0000 00C1     PORTC = 0b01000000;
	LDI  R30,LOW(64)
	OUT  0x15,R30
; 0000 00C2     delay_ms(1);
	RCALL SUBOPT_0x2
; 0000 00C3 
; 0000 00C4     PORTD = 0b11111111; //isi kolom 8
; 0000 00C5     PORTC = 0b10000000;
	LDI  R30,LOW(128)
	OUT  0x15,R30
