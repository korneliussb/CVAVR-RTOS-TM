...
; 0000 0023 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0024 // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0035 // Func7=Out Func6=Out Func5=Out Func4=Out Func3=Out Func2=Out Func1=Out Func0=Out
; 0000 0036 // State7=0 State6=0 State5=0 State4=0 State3=0 State2=0 State1=0 State0=0
...
; 0000 0087     PORTB = 0b11111111; //isi kolom 1
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 0088     PORTA = 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x0
; 0000 0089 //mengaktifkan baris 1 , active low
; 0000 008A     delay_ms(1);
; 0000 008B 
; 0000 008C     PORTB = 0b11111111; //isi kolom 2
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 008D     PORTA = 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x0
; 0000 008E     delay_ms(1);
; 0000 008F 
; 0000 0090     PORTB = 0b10000001; //isi kolom 3
	LDI  R30,LOW(129)
	OUT  0x18,R30
; 0000 0091     PORTA = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x0
; 0000 0092     delay_ms(1);
; 0000 0093 
; 0000 0094     PORTB = 0b01111110; //isi kolom 4
	LDI  R30,LOW(126)
	OUT  0x18,R30
; 0000 0095     PORTA = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x0
; 0000 0096     delay_ms(1);
; 0000 0097 
; 0000 0098     PORTB = 0b01111110; //isi kolom 5
	LDI  R30,LOW(126)
	OUT  0x18,R30
; 0000 0099     PORTA = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x0
; 0000 009A     delay_ms(1);
; 0000 009B 
; 0000 009C     PORTB = 0b10000001; //isi kolom 6
	LDI  R30,LOW(129)
	OUT  0x18,R30
; 0000 009D     PORTA = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 009E     delay_ms(1);
; 0000 009F 
; 0000 00A0     PORTB = 0b11111111; //isi kolom 7
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 00A1     PORTA = 0b0100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x0
; 0000 00A2     delay_ms(1);
; 0000 00A3 
; 0000 00A4     PORTB = 0b11111111; //isi kolom 8
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 00A5     PORTA = 0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x0
; 0000 00A6     delay_ms(1);
; 0000 00A7 
; 0000 00A8 
; 0000 00A9     PORTD = 0b11111111; //isi kolom 1
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 00AA     PORTC = 0b00000001;
	LDI  R30,LOW(1)
	RCALL SUBOPT_0x1
; 0000 00AB     delay_ms(1);
; 0000 00AC 
; 0000 00AD     PORTD = 0b00000000; //isi kolom 2
; 0000 00AE     PORTC = 0b00000010;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x1
; 0000 00AF     delay_ms(1);
; 0000 00B0 
; 0000 00B1     PORTD = 0b00000000; //isi kolom 3
; 0000 00B2     PORTC = 0b00000100;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x2
; 0000 00B3     delay_ms(1);
; 0000 00B4 
; 0000 00B5     PORTD = 0b11111100; //isi kolom 4
; 0000 00B6     PORTC = 0b00001000;
	LDI  R30,LOW(8)
	RCALL SUBOPT_0x2
; 0000 00B7     delay_ms(1);
; 0000 00B8 
; 0000 00B9     PORTD = 0b11111100; //isi kolom 5
; 0000 00BA     PORTC = 0b00010000;
	LDI  R30,LOW(16)
	RCALL SUBOPT_0x2
; 0000 00BB     delay_ms(1);
; 0000 00BC 
; 0000 00BD     PORTD = 0b11111100; //isi kolom 6
; 0000 00BE     PORTC = 0b00100000;
	LDI  R30,LOW(32)
	RCALL SUBOPT_0x2
; 0000 00BF     delay_ms(1);
; 0000 00C0 
; 0000 00C1     PORTD = 0b11111100; //isi kolom 7
; 0000 00C2     PORTC = 0b01000000;
	LDI  R30,LOW(64)
	RCALL SUBOPT_0x3
; 0000 00C3     delay_ms(1);
; 0000 00C4 
; 0000 00C5     PORTD = 0b11111111; //isi kolom 8
	LDI  R30,LOW(255)
	OUT  0x12,R30
; 0000 00C6     PORTC = 0b10000000;
	LDI  R30,LOW(128)
	RCALL SUBOPT_0x3
